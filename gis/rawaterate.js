// peta rawa terate
const mymap = L.map("mapdiv").setView([-6.178461561613726, 106.92347650392048], 14)
...
const rawanBanjir = L.tileLayer.wms("http://localhost/geoserver/wms?",{
    layers: "simplygeo:RawaTerateBanjir",
    format: "image/png",
    transparent:true
})
...
const waterways = L.tileLayer.wms("http://localhost/geoserver/wms?",{
    layers: "simplygeo:RawaTerateWaterways",
    format: "image/png",
    transparent:true
})
...
const batasKelurahan = L.tileLayer.wms("http://localhost/geoserver/wms?",{
    layers: "simplygeo:BatasKelurahan",
    format: "image/png",
    transparent:true,
    style: batasStyle
})
